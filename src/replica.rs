...
# use taskchampion::{storage::AccessMode, Operations, Replica, Status, StorageConfig, Uuid, storage::SqliteStorage};
# use tempfile::TempDir;
# #[tokio::main]
# async fn main() -> anyhow::Result<()> {
# let tmp_dir = TempDir::new()?;
# let mut replica: Replica<SqliteStorage> = Replica::new(StorageConfig::OnDisk {
...
impl<S: Storage> Replica<S> {
    ...
    pub(crate) fn new_inmemory() -> Replica<InMemoryStorage> {
        ...
        StorageConfig::InMemory.try_into().unwrap()
    }
